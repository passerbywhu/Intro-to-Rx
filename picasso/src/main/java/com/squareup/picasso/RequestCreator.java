...
public class RequestCreator {
   ...
   */
  public void into(Target target, boolean notDecode) {
    long started = System.nanoTime();
    checkMain();
    ...
    Request request = createRequest(started, notDecode);
  ...
  private Request createRequest(long started, boolean notDecode) {
    int id = nextId.getAndIncrement();

    Request request = data.build();
    request.id = id;
    request.started = started;
    request.notDecode = notDecode;
  ...
  private Request createRequest(long started) {
    return createRequest(started, false);
  }
